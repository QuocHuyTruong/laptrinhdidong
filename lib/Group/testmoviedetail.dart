...
class MoviedetailTest extends StatefulWidget {
  final dataphim;
  final id;
  const MoviedetailTest({this.id, this.dataphim});

  @override
  createState() => _MoviedetailTestState(this.id,this.dataphim);
}

class _MoviedetailTestState extends State<MoviedetailTest> {
  Result datamovie;
  int id;
  var data;
  var favorite;
  var index;
  _MoviedetailTestState(this.id, this.datamovie);
